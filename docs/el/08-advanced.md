...
το ποντίκι ή αλληλεπιδρά με αυτό. Να το καλείτε πάντα μετά την αλλαγή κατάστασης από
μια γορουτίνα.
...
βάσει χρόνου — καλέστε «Invalidate» στο τέλος κάθε καρέ για να διατηρήσετε τις επανασχεδιασίες
πηγαίνοντας:
