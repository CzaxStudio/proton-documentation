...
**Signature:**
```go
proton.Input(win *Win, state *proton.Editor, hint string)
```
...
**Signature:**
```go
proton.TextArea(win *Win, state *proton.Editor, hint string)
```
...
**Signature:**
```go
proton.Checkbox(win *Win, state *proton.Bool, label string) bool
```
...
**Signature:**
```go
proton.Toggle(win *Win, state *proton.Bool, label string) bool
```
...
**Signature:**
```go
proton.RadioButton(win *Win, group *proton.Enum, key string, label string) bool
```
...
```go
proton.Row(win,
    func(win *proton.Win) { proton.RadioButton(win, &u.size, "sm", "S") },
    func(win *proton.Win) { proton.Gap(win, 8) },
    func(win *proton.Win) { proton.RadioButton(win, &u.size, "md", "M") },
    func(win *proton.Win) { proton.Gap(win, 8) },
    func(win *proton.Win) { proton.RadioButton(win, &u.size, "lg", "L") },
)
```
...
**Signature:**
```go
proton.Slider(win *Win, state *proton.Float) float32
```
...
**Signature:**
```go
proton.ProgressBar(win *Win, progress float32)
```
...
func drawSettings(win *proton.Win, s *SettingsUI) {
    ...
    proton.Pad(win, 0, func(win *proton.Win) {
