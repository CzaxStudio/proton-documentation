...
Τα κουμπιά είναι ο τρόπος με τον οποίο οι χρήστες λένε στην εφαρμογή σας να κάνει πράγματα. Το πρωτόνιο έχει τέσσερα είδη,
συν συνδέσμους με δυνατότητα κλικ και έναν τρόπο για να κάνετε κυριολεκτικά οτιδήποτε πατήσιμο.
...
Υπογραμμισμένο κείμενο με δυνατότητα κλικ με στυλ υπερ-σύνδεσης. Διαχειριστείτε μόνοι σας το κλικ —
