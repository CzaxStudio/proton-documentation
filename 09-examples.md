...
func main() {
    ...
    a.Window("Todo", 420, 560, func(win *proton.Win) {
        draw(win, u)
    })
    a.Run()
}
...
func draw(win *proton.Win, u *UI) {
    ...
    proton.List(win, &u.scroll, len(u.items), func(win *proton.Win, i int) {
        t := &u.items[i]
        proton.PadV(win, 6, func(win *proton.Win) {
...
func main() {
    ...
    a.Window("Sign In", 400, 320, func(win *proton.Win) {
        draw(win, u)
    })
    a.Run()
}
...
func draw(win *proton.Win, u *UI) {
    proton.Center(win, func(win *proton.Win) {
        proton.MaxWidth(win, 320, func(win *proton.Win) {
...
func main() {
    ...
    a.Window("Settings", 480, 500, func(win *proton.Win) {
        drawSettings(win, s)
    })
    a.Run()
}

func drawSettings(win *proton.Win, s *Settings) {
...
func main() {
    ...
    a.ApplyPalette(proton.NordPalette)
    a.Window("Dashboard", 640, 400, func(win *proton.Win) {
...
func statCards(stats []Stat) []func(*proton.Win) {
    fns := make([]func(*proton.Win), len(stats))
    for i, s := range stats {
        s := s
        fns[i] = func(win *proton.Win) {
            proton.Card(win, proton.RGB(0x3b4252), 10, 16, func(win *proton.Win) {
...
// helper — Grid takes []func(*Win) not ...func(*Win) directly here
